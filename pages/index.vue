    ...
    >
      ...
      <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
        <a
          ...
          href="https://www.searchandstay.com/"
          target="_blank"
        >
          <img
            class="ma-1 d-flex elevation-0 white lighten-3"
            :src="require('../static/sas-logo.png')"
          />
        </a>
        <div class="mt-8 bg-white overflow-hidden shadow sm:rounded-lg p-6">
          <CRUD v-if="userLoginData" :userLoginData="userLoginData" />
          <Login v-else @userLoggedIn="handleLogin" />
        </div>
        <div class="flex justify-center pt-4 space-x-2">
          <a href="https://github.com/jvictorjs/sas-task" target="_blank"
            ><svg
            ...
            >
              ...
              /></svg
          ></a>
          <a href="https://twitter.com/jvictor_js" target="_blank"
            ><svg
...
export default {
  ...
  methods: {
    handleLogin(loginData) {
      this.userLoginData = loginData.userLoginData
    },
  },
}
</script>
